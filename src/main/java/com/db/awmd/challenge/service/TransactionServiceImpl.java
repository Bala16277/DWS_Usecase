...
public class TransactionServiceImpl implements TransactionService {
	...
	public String transferAmount(String accountToId, String accountFromId, BigDecimal amount)
		...
		try {
			...
			transactionRepository.performTransaction(fromAccount);
			transactionRepository.performTransaction(toAccount);
		} finally {
		...
		return "amount  transferred successfully, remaining balance:" + fromAccount.getBalance();
	}
}